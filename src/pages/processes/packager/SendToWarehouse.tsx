...
const SendToWarehouse = () => {
  ...
  const { data: products } = usePaginatedData<Product>("/product/search?searchType=SENDING_TO_WAREHOUSE", 1000, false);
  ...
  return (
    <div className="main-container">
      <h1 style={{ marginBottom: "10px" }}>Mahsulotni skladga yuborish</h1>

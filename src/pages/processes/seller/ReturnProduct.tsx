...
const ReturnProduct = () => {
  ...
  const { data: products } = usePaginatedData<Product>("/product/search?searchType=RETURNING_PRODUCT", 1000, false);
  ...
  return (
    <div className="main-container">
      <h1 style={{ marginBottom: "10px" }}>Sotilmagan tovarni qaytarish</h1>
